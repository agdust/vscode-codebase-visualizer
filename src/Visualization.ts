		                  ...
		                  <div id="sidebar">
		                      <div class="sidebar-header">
		                          ...
		                          <button id="close-sidebar" class="icon-button" title="Close Sidebar">
		                              <svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="currentColor"><path d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z"/></svg>
		                          </button>
		                      </div>
		                      <div id="filters">
		                          <div class="form-group">
		                              <label for="include">Files to include</label>
		                              <input id="include" title="e.g. **/*.ts, src/**/include" placeholder="**/*"></input>
		                          </div>
		                          <div class="form-group">
		                              <label for="exclude">Files to exclude</label>
		                              <input id="exclude" title="e.g. **/*.ts, src/**/include" placeholder="node_modules/**"></input>
		                          </div>
		                      </div>
		                  </div>
		                  <div id="content">
		                      <button id="open-sidebar" class="icon-button" title="Open Settings">
		                          <svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="currentColor"><path fill-rule="evenodd" d="M2.5 12a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5z"/></svg>
		                      </button>
		                      <svg id="diagram"></svg>
		                  </div>
		              </div>
